...
impl From<watchtower_client::Error> for FlockError {
    fn from(error: watchtower_client::Error) -> Self {
        println!("WatchtowerClient Error: {:?}", error);
        FlockError::InternalError
    }
}
